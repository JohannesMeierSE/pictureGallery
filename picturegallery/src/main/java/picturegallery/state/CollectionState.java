...
import picturegallery.action.CreateNewCollectionAction;
import picturegallery.action.DebuggerCollectionAction;
import picturegallery.action.DeleteCollectionAction;
...
public class CollectionState extends State {
	...
	public void onInit() {
		...
		registerAction(new CreateNewCollectionAction());
		registerAction(new DeleteCollectionAction());
